...
const PAGES = [
  ...
  { fichier: '45-service-etiquetage.html', titre: 'Fiche Étiquetage et publicité', source: 'pages/38-service.html (gabarit), 15/09/2026' },
  { fichier: '45-service-etiquetage-en.html', titre: 'Service page Labelling and advertising EN', source: 'pages/38-service-en.html (template)', en: true },
  { fichier: '46-service-emballage.html', titre: 'Fiche Emballage', source: 'pages/38-service.html (gabarit), 15/09/2026' },
  { fichier: '46-service-emballage-en.html', titre: 'Service page Packaging EN', source: 'pages/38-service-en.html (template)', en: true },
  { fichier: '47-service-specifications.html', titre: 'Fiche Spécifications', source: 'pages/38-service.html (gabarit), 15/09/2026' },
  { fichier: '47-service-specifications-en.html', titre: 'Service page Specifications EN', source: 'pages/38-service-en.html (template)', en: true },
  { fichier: '48-service-contrats.html', titre: 'Fiche Contrats', source: 'pages/38-service.html (gabarit), 15/09/2026' },
  { fichier: '48-service-contrats-en.html', titre: 'Service page Contracts EN', source: 'pages/38-service-en.html (template)', en: true },
  { fichier: '49-service-formalites.html', titre: 'Fiche Formalités administratives', source: 'pages/38-service.html (gabarit), 15/09/2026' },
